...
double V_p_scf(
  ...
  return  pow(pba->scf_M,4)*pow((pba->scf_M / phi),  scf_alpha);
}
...
double dV_p_scf(
  ...
  return   -pow(pba->scf_M,3)*scf_alpha*pow((pba->scf_M / phi),  scf_alpha + 1);
}
...
double ddV_p_scf(
  ...
  return  pow(pba->scf_M,2)*scf_alpha*(scf_alpha + 1.)*pow((pba->scf_M / phi),  scf_alpha + 2);
}
